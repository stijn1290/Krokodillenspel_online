    ...
    <main class="flex items-center justify-center mt-20">
        <div class="bg-[#57B404] w-1/2 p-6 rounded-2xl">
            ...
            <p class="custom-outline text-[28px] leading-relaxed mb-6">
                Het klassieke kinderspel is volwassen geworden en hij is dorstig! Het Tandjes Druk Spel: Drankvariant is
                dé perfecte ijsbreker voor feestjes, borrels of gewoon een hilarische avond met vrienden. Simpel,
                spannend en een tikje gevaarlijk... voor je lever.
            </p>

            <h2 class="custom-outline text-[36px] font-bold mb-4">Hoe werkt het?</h2>
            <p class="custom-outline text-[28px] leading-relaxed mb-6">
                Elke speler drukt om de beurt op één tand van de krokodil. Eén daarvan is de foute tand – druk daarop,
                en de krokodil hapt toe! Word jij gebeten? Dan drink je. Zo simpel is het.
            </p>
